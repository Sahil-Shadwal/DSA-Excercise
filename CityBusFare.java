 ...
 * fraction value should be ceiled. For example, for distance 900 when fare
 ...
 * take Input as source and destination stops (in the format containing first
 * two characters of the Name of the Bus Stop) and calculate and return travel
 * fare.
 *
 * Example 1:
 * Input Values
